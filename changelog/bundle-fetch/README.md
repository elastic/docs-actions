...
| `output`               | Output file path for the bundle, relative to the repo root. Optional; when omitted in profile mode, the plan resolves `{repo}-{product}-{version}.yaml` under bundle.output_directory.<br>                                           | `false`  | ` `                   |
