...
To keep bundles in their separate folders, set `output_directory` on each profile.
It replaces the global directory for that profile only; the conventional filename is unchanged:
