---
description: >
  Labels a newly opened issue with the right type and team labels. A router sub-agent classifies;
  the parent applies labels and reacts with 👍. The issue body is never rewritten and no comment
