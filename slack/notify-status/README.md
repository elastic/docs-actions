...
- Top-level text uses the repository and workflow name. The attachment shows status color, PR or commit metadata, optional resolution text, and a workflow run link.
